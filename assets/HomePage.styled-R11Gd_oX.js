import{t as de,r as ve,J as Je,K as Ge,u as y,j as Z}from"./index-9bmQuCQ1.js";import{b as Qe,E as Xe,e as Ze}from"./index.esm-Txe857km.js";var ie={exports:{}},U={},Me={exports:{}},et="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",tt=et,nt=tt;function Te(){}function Re(){}Re.resetWarningCache=Te;var ot=function(){function t(r,s,p,O,a,b){if(b!==nt){var d=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw d.name="Invariant Violation",d}}t.isRequired=t;function e(){return t}var o={array:t,bigint:t,bool:t,func:t,number:t,object:t,string:t,symbol:t,any:t,arrayOf:e,element:t,elementType:t,instanceOf:e,node:t,objectOf:e,oneOf:e,oneOfType:e,shape:e,exact:e,checkPropTypes:Re,resetWarningCache:Te};return o.PropTypes=o,o};Me.exports=ot();var he=Me.exports;const vn=de(he);var ue={exports:{}},R={},ce={exports:{}};(function(t,e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=h;/*!
...
`,fn=y.h2`
  ...
  padding: 0;
  margin-bottom: 24px;
`;Ie.setAppElement("#root");function mn({children:t,modalIsOpen:e,closeModal:o,title:r,maxWidth:s}){const p={overlay:{backgroundColor:"rgb(21, 21, 21, 0.75)"},content:{maxWidth:s}};return Z.jsx("div",{children:Z.jsxs(Ie,{className:"ReactModalContentClassName",isOpen:e,onRequestClose:o,style:p,contentLabel:"Sample Modal",closeTimeoutMS:750,children:[Z.jsx(cn,{onClick:o,children:"✕"}),Z.jsx(fn,{children:r}),t]})})}const yn=()=>{const[t,e]=ve.useState(!1);return{isModalOpen:t,openModal:()=>{e(!0)},closeModal:()=>{e(!1)}}},bn=y.div`
  display: flex;
...
`,Dn=y(Ze)`
  ...
  display: flex;
  flex-direction: column;
`,An=t=>t.dashboards.dashboards,Fn=t=>t.dashboards.currentDashboard,Ln=y.div`
  display: flex;
  min-height: 100vh;
  /* height: 100vh; */
...
`;export{Tn as A,Mn as B,xn as C,wn as D,Nn as E,gn as F,Ln as H,En as I,Dn as M,Un as O,Pn as P,Cn as R,mn as S,_n as T,bn as a,On as b,Sn as c,Rn as d,An as e,kn as f,cn as g,vn as h,Ie as i,he as p,Fn as s,yn as u,hn as w};
