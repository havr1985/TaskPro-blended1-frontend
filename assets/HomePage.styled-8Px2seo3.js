import{v as Ne,r as me,J as Xe,K as Ze,u as y,j as Z}from"./index-u8G9WHG0.js";import{b as et,E as tt,e as nt}from"./index.esm-D1Kqx4da.js";var fe={exports:{}},U={},ie={exports:{}},ue,Oe;function ot(){if(Oe)return ue;Oe=1;var t="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return ue=t,ue}var ce,_e;function rt(){if(_e)return ce;_e=1;var t=ot();function e(){}function o(){}return o.resetWarningCache=e,ce=function(){function r(O,a,g,v,h,p){if(p!==t){var d=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw d.name="Invariant Violation",d}}r.isRequired=r;function s(){return r}var f={array:r,bigint:r,bool:r,func:r,number:r,object:r,string:r,symbol:r,any:r,arrayOf:s,element:r,elementType:r,instanceOf:s,node:r,objectOf:s,oneOf:s,oneOfType:s,shape:s,exact:s,checkPropTypes:o,resetWarningCache:e};return f.PropTypes=f,f},ce}var Ce;function De(){return Ce||(Ce=1,ie.exports=rt()()),ie.exports}var pe={exports:{}},R={},de={exports:{}};(function(t,e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=h;/*!
...
`,Nn=y(nt)`
	...
	display: flex;
	flex-direction: column;
`,Dn=t=>t.dashboards.dashboards,An=t=>t.dashboards.currentDashboard,Fn=()=>{const[t,e]=me.useState(!1);return{isModalOpen:t,openModal:()=>{e(!0)},closeModal:()=>{e(!1)}}},Ln=y.div`
  display: flex;
  min-height: 100vh;
  /* height: 100vh; */
...
`;export{Mn as A,xn as B,wn as C,Sn as D,Pn as E,bn as F,Ln as H,Cn as I,Nn as M,Un as O,Rn as P,_n as R,mn as S,On as T,yn as a,gn as b,En as c,Tn as d,Dn as e,kn as f,fn as g,Be as h,De as r,An as s,Fn as u,hn as w};
