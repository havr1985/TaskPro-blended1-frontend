import{u as h,t as oa,j as o,r as N,v as ia,w as nt,R as g,x as gt,b as ke,y as Ln,a as bt,z as In,A as Wn,D as Fn,E as $n,F as Rn,G as la,i as ca,H as zn,q as Vn,f as Yn,I as Bn}from"./index-cGiFshPX.js";import{i as U}from"./icons-I0FOP6sp.js";import{g as qn,w as Gn,h as s,i as yt,u as Le,S as xt,p as Hn,s as ir,a as sa,M as ua,F as da,E as fa,d as ha,P as va,O as Ir,e as Un}from"./HomePage.styled-Zs5sm1MF.js";import{b as lr,E as pa,c as wt,a as ge,d as ma,F as Dt}from"./index.esm-zgwC-Ia3.js";const Zn=h.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,lc=wt().shape({title:ge().min("6").required("specify a column name")}),cc=({isModalOpen:e,modalStateSwapper:t,title:a,columnId:r})=>{const n=ke(),i={title:a||""},l=({title:c},u)=>{n($n({columnId:r,title:c})),u.resetForm(),t()};return o.jsx(xt,{modalIsOpen:e,closeModal:t,title:"Edit column",maxWidth:"335px",children:o.jsx(sa,{children:o.jsx(Dt,{initialValues:i,validationSchema:lc,onSubmit:l,children:o.jsxs(ua,{children:[o.jsxs(da,{children:[o.jsx(fa,{name:"title",component:"div"}),o.jsx(oc,{type:"text",id:"title",name:"title",placeholder:"title",autoComplete:"off"})]}),o.jsxs(ic,{type:"submit",children:[o.jsx(ha,{children:o.jsx(va,{children:o.jsx("use",{href:U+"#icon-plus"})})}),"Add"]})]})})})})};yt.setAppElement("#root");const sc=wt().shape({title:ge().required("Title is required"),description:ge().required("Description is required"),color:ge().required("Color selection is required"),deadline:ma().required("Deadline is required")});function uc({isModalOpen:e,modalStateSwapper:t,columnId:a}){const[r,n]=N.useState(new Date),i=ke(),{isModalOpen:l,openModal:c,closeModal:u}=Le(),d={overlay:{backgroundColor:"rgb(21, 21, 21, 0.75)"},content:{width:"233px",height:"254px",margin:"auto",padding:0,border:"none",borderRadius:"8px"}},v=(p,{setSubmitting:x,resetForm:D})=>{const j={columnId:a,title:p.title,description:p.description,color:p.color,deadline:r};i(Rn(j)),x(!1),D(),t(),setTimeout(()=>{n(new Date)},1e3)},m=(p,x)=>["Su","Mo","Tu","We","Th","Fr","Sa"][x.getDay()],w=p=>{const x=new Date(p),D=x.getDate(),j=x.toLocaleString("en",{month:"long"});return`${x.toLocaleString("en",{weekday:"long"})}, ${j} ${D}`};return o.jsx(o.Fragment,{children:o.jsxs(xt,{modalIsOpen:e,closeModal:t,title:"Add card",maxWidth:"350px",children:[o.jsx(Dt,{initialValues:{title:"",description:"",color:"gray",deadline:new Date},validationSchema:sc,onSubmit:v,children:({values:p,handleChange:x,handleSubmit:D})=>o.jsxs(rn,{onSubmit:D,children:[o.jsxs(mt,{children:[o.jsx(sn,{type:"text",name:"title",onChange:x,value:p.title,placeholder:"Title"}),o.jsx(vn,{name:"title",component:"div",className:"error"})]}),o.jsxs(mt,{children:[o.jsx(an,{name:"description",onChange:x,value:p.description,placeholder:"Description"}),o.jsx(pn,{name:"description",component:"div",className:"error"})]}),o.jsx(ln,{children:"Label color"}),o.jsxs(cn,{onChange:x,value:p.color,children:[o.jsxs(me,{children:[o.jsx(pe,{type:"radio",name:"color",value:"blue",className:"blue",checked:p.color==="blue",onChange:x}),o.jsx(fe,{className:"blue"})]}),o.jsxs(me,{children:[o.jsx(pe,{type:"radio",name:"color",value:"pink",className:"pink",checked:p.color==="pink",onChange:x}),o.jsx(fe,{className:"pink"})]}),o.jsxs(me,{children:[o.jsx(pe,{type:"radio",name:"color",value:"green",className:"green",checked:p.color==="green",onChange:x}),o.jsx(fe,{className:"green"})]}),o.jsxs(me,{children:[o.jsx(pe,{type:"radio",name:"color",value:"gray",className:"gray",checked:p.color==="gray",onChange:x}),o.jsx(fe,{className:"gray"})]})]}),o.jsx(on,{children:"Deadline"}),o.jsxs(nn,{onClick:c,children:[o.jsx(un,{children:w(r)}),o.jsx(mn,{children:o.jsx("use",{href:U+"#icon-chevron-down"})})]}),o.jsxs(hn,{type:"submit",children:[o.jsx(dn,{children:o.jsx(fn,{children:o.jsx("use",{href:U+"#icon-plus"})})}),"Add"]})]})}),o.jsx(yt,{isOpen:l,onRequestClose:u,style:d,closeTimeoutMS:750,children:o.jsx(tn,{formatShortWeekday:m,selectedDate:new Date,onChange:n,onClickDay:u,minDate:new Date,prevLabel:"<",nextLabel:">"})})]})})}const dc=()=>{const{isModalOpen:e,openModal:t,closeModal:a}=Le(),{isModalOpen:r,openModal:n,closeModal:i}=Le(),{isModalOpen:l,openModal:c,closeModal:u}=Le(),{column:d}=bt(ir),{state:v}=la(),m=ke(),[w,p]=N.useState(null);N.useEffect(()=>{d===void 0&&v&&m(ca(v.id))},[d,m,v==null?void 0:v.id,v]);const x=D=>{m(zn(D))};return o.jsxs(Yl,{children:[o.jsx(Bl,{children:d===void 0?o.jsx(o.Fragment,{}):d.map(({_id:D,title:j,card:_})=>o.jsxs(ql,{children:[o.jsx("div",{children:o.jsxs(Jl,{children:[o.jsx(Ql,{children:j}),o.jsxs(ec,{children:[o.jsx(aa,{onClick:()=>{n(),p(D)},children:o.jsx(na,{children:o.jsx("use",{href:U+"#icon-pencil"})})}),o.jsx(aa,{onClick:()=>x(D),children:o.jsx(na,{children:o.jsx("use",{href:U+"#icon-trash"})})})]})]})}),o.jsx(Vl,{card:_}),o.jsx("div",{children:o.jsxs(Hl,{onClick:()=>{c(),p(D)},children:[o.jsx(Zl,{children:o.jsx(Xl,{children:o.jsx("use",{href:U+"#icon-plus"})})}),"Add Card"]})})]},D))}),o.jsxs(Gl,{onClick:t,children:[o.jsx(Ul,{children:o.jsx(Kl,{children:o.jsx("use",{href:U+"#icon-plus"})})}),"Add column"]}),o.jsx(Ir,{onClick:a,className:e===!0&&"active"}),o.jsx(nc,{modalStateSwapper:a,isModalOpen:e}),o.jsx(Ir,{onClick:i,className:r===!0&&"active"}),o.jsx(cc,{modalStateSwapper:i,isModalOpen:r,columnId:w}),o.jsx(uc,{modalStateSwapper:u,isModalOpen:l,columnId:w})]})},fc=h.div`
	flex-grow: 1;
	padding-top: 14px;
	/* padding-bottom: 40px; */
	padding-left: 20px;
...
`,xc=()=>{var p;const[e,t]=N.useState(!1),[a,r]=N.useState(""),n=N.useRef(!0),{boardName:i}=Vn(),l=Yn(),c=la(),u=bt(Un),d=ke(),[v,m]=N.useState(u),w=()=>u.filter(D=>D.title===i);return N.useEffect(()=>{r(i)},[c.pathname,i]),N.useEffect(()=>{var x;if(m(u),!(n.current!==!0&&i!==a)){if(u.length===0&&l("/home",{replace:!0}),v.length!==u.length&&i&&u.length>0&&d(ca((x=u[u.length-1])==null?void 0:x._id)),u.length>0&&!i){t(!0);const D=u[u.length-1]??"";r(D.title),l(`/home/${D.title}`,{replace:!0,state:{id:D._id}}),t(!1)}n.current=!1}},[u,l,i,a,v.length,d]),o.jsx(fc,{$bcgurl:(p=w()[0])==null?void 0:p.backgroundURL,children:e?o.jsx("div",{children:o.jsx(Bn,{})}):i===void 0&&o.jsx(hc,{children:o.jsxs(vc,{children:["Before starting your project, it is essential"," ",o.jsx(pc,{children:"to create a board"})," to visualize and track all the necessary tasks and milestones. This board serves as a powerful tool to organize the workflow and ensure effective collaboration among team members."]})})||i!==void 0&&o.jsxs(o.Fragment,{children:[o.jsx(co,{boardName:i}),o.jsx(dc,{})]})})};export{xc as default};
