import{u as t,j as e,a as v,r as u,b as k,s as U,c as te,d as oe,B as H,e as re,N as ie,f as ne,g as ae,h as se,l as le,i as ce,k as de,C as pe,O as he}from"./index-MtbUvCMT.js";import{i as g}from"./icons-iplVKqot.js";import{T as ue}from"./ThemeMenu-0u7PmIlv.js";import{S as I,a as P,M as $,F as f,E as A,T as F,b as B,R as _,I as W,c as R,D as M,B as V,C as Q,A as X,d as Y,P as J,s as K,u as E,O as Z,e as xe,H as me,f as ge}from"./HomePage.styled-FZKQXbyp.js";import{c as q,a as C,F as ee,u as be}from"./index.esm-qILmVYBW.js";/* empty css                      */const je=t.header`
  height: 60px;
...
`,et=["#icon-board-square","#icon-board-star","#icon-board-loading","#icon-board-puzzle","#icon-board-container","#icon-board-lightning","#icon-board-colors","#icon-board-hexagon"],tt=q().shape({title:C().required("Title is required!")}),ot=({isModalOpen:i,modalStateSwapper:n})=>{const l=v(),o=k(K),{_id:d,title:c,icon:h,backgroundURL:x}=o.result,[m,b]=u.useState(x),[j,r]=u.useState(h),p={title:c,icon:h,backgroundURL:x},s=a=>{a.preventDefault();const w=a.target.elements[0].value,D={dashboardId:d,title:w,icon:j,backgroundURL:m};n(),console.log(D),l(ne(D))},S=a=>{b(a)},y=a=>{r(a)};return e.jsx(I,{modalIsOpen:i,closeModal:n,title:"Edit board",maxWidth:"350px",children:e.jsx(P,{children:e.jsx(ee,{initialValues:p,validationSchema:tt,children:e.jsxs($,{onSubmit:a=>s(a),children:[e.jsxs(f,{children:[e.jsx(A,{name:"title",component:"div"}),e.jsx(F,{type:"text",id:"title",name:"title",autoComplete:"off"})]}),e.jsxs(f,{children:[e.jsx(B,{children:"Icons "}),e.jsx(_,{children:et.map((a,w)=>e.jsxs(W,{children:[e.jsx(R,{className:j===a?"active":"",onClick:()=>y(a),width:18,height:18,children:e.jsx("use",{href:g+a,width:18,height:18})}),e.jsx(M,{type:"radio",value:a,name:"icon"})]},w))})]}),e.jsxs(f,{children:[e.jsx(B,{children:"Backgraunds "}),e.jsx(_,{children:T.map((a,w)=>e.jsxs("label",{children:[e.jsx(V,{onClick:()=>S(a.url),className:m===a.url?"active":"",children:a.url!==""&&e.jsx(Q,{url:a.url,onClick:()=>S(a.url),className:m===a.url?"active":""})}),e.jsx(M,{type:"radio",value:a.url,name:"bg"})]},w))})]}),e.jsxs(X,{type:"submit",children:[e.jsx(Y,{children:e.jsx(J,{children:e.jsx("use",{href:g+"#icon-plus"})})}),"Edit"]})]})})})})},rt=({icon:i,boards:n,selectedItem:l,choice:o,setUserBoards:d})=>{const{isModalOpen:c,openModal:h,closeModal:x}=E(),[m,b]=u.useState(!1),j=()=>{b(s=>!s)},r=v(),p=s=>{r(ae(s))};return e.jsxs("div",{children:[e.jsx(We,{children:"My boards"}),e.jsxs(Re,{children:[e.jsx("p",{className:"createText",children:"Create a new board"}),e.jsx(Ve,{onClick:()=>h(),type:"submit",children:e.jsx("svg",{className:"iconCreateBoard",width:"20px",height:"20px",children:e.jsx("use",{href:`${i}#icon-plus`})})})]}),n.length!==0&&e.jsx(Qe,{children:n.map(s=>e.jsx(Xe,{onClick:()=>o(s),className:l._id===s._id?"active":"",children:e.jsxs(Ye,{to:`/home/${s.title}`,children:[e.jsxs(Je,{children:[e.jsx(N,{className:"iconBoard iconActive",width:"20px",height:"20px",children:e.jsx("use",{href:`${i}${s.icon}`})}),e.jsx(Ke,{children:s.title})]}),l.id===s.id&&e.jsxs(Ze,{children:[e.jsx(L,{onClick:()=>j(),type:"button",children:e.jsx(N,{className:"iconBoard iconEdit",width:"16px",height:"16px",children:e.jsx("use",{href:`${i}#icon-pencil`})})}),e.jsx(L,{onClick:()=>p(s._id),type:"button",children:e.jsx(N,{className:"iconBoard iconEdit",width:"16px",height:"16px",children:e.jsx("use",{href:`${i}#icon-trash`})})})]})]})},s._id))}),e.jsx(Fe,{setUserBoards:d,isModalOpen:c,modalStateSwapper:x}),m&&e.jsx(ot,{isModalOpen:m,modalStateSwapper:j})]})},it="/TaskPro-blended1-frontend/assets/plant-92SCXr2v.png",nt=t.div`
	width: 212px;
	height: 272px;
...
`,ht=q().shape({email:C().email("Invalid email").required("Email is required"),comment:C().min(50,"Must be at least 50 characters long").required()}),ut=({isModalOpen:i,modalStateSwapper:n})=>{const l=v(),o=be({initialValues:{email:"",comment:""},validationSchema:ht,onSubmit:async d=>{try{await l(se({email:d.email,comment:d.comment})).unwrap()&&H.success("Your message was successfully sent"),n(),o.resetForm()}catch(c){console.log(c)}}});return e.jsx(I,{modalIsOpen:i,closeModal:n,title:"Need help",maxWidth:"335px",children:e.jsxs(ct,{onSubmit:o.handleSubmit,children:[e.jsxs(f,{children:[e.jsx(lt,{type:"text",name:"email",placeholder:"Email address",onChange:o.handleChange,onBlur:o.handleBlur,value:o.values.email,autoComplete:"off"}),o.touched.email&&o.errors.email?e.jsx(O,{children:o.errors.email}):null]}),e.jsxs(f,{children:[e.jsx(dt,{as:"textarea",rows:"6",name:"comment",placeholder:"Comment",autoComplete:"off",onChange:o.handleChange,onBlur:o.handleBlur,value:o.values.comment}),o.touched.comment&&o.errors.comment?e.jsx(O,{children:o.errors.comment}):null]}),e.jsx(pt,{type:"submit",children:"Submit"})]})})},xt=({icon:i})=>{const{isModalOpen:n,openModal:l,closeModal:o}=E();return e.jsxs(e.Fragment,{children:[e.jsxs(nt,{children:[e.jsx("img",{className:"img-plant",src:it,alt:"Happy plant"}),e.jsxs(at,{children:["If you need help with ",e.jsx("span",{className:"appName",children:"TaskPro"}),", check out our support resources or reach out to our customer support team."]}),e.jsxs(st,{type:"submit",onClick:l,children:[e.jsx("svg",{className:"iconHelp",width:"20px",height:"20px",children:e.jsx("use",{href:`${i}#icon-help-circle`})}),e.jsx("span",{children:"Need help?"})]})]}),e.jsx(Z,{onClick:o,className:n===!0&&"active"}),e.jsx(ut,{modalStateSwapper:o,isModalOpen:n})]})},mt=t.button`
	width: 105px;
	height: 32px;
...
`,gt=({icon:i})=>{const n=v();return e.jsxs(mt,{onClick:()=>n(le()),type:"submit",children:[e.jsx("svg",{className:"iconLogOut",width:"32px",height:"32px",children:e.jsx("use",{href:`${i}#icon-logout`})}),e.jsx("span",{children:"Log out"})]})},bt=({isOpen:i})=>{const[n,l]=u.useState(""),o=k(xe),{result:d}=k(K),[c,h]=u.useState([]),x=v();u.useEffect(()=>{h(o)},[o]),u.useEffect(()=>{l(d??"")},[d]);const m=b=>{x(ce(b._id))};return e.jsxs(He,{className:i===!0&&"active",children:[e.jsxs("div",{children:[e.jsx($e,{icon:g}),e.jsx(rt,{icon:g,boards:c,choice:m,selectedItem:n})]}),e.jsxs("div",{children:[e.jsx(xt,{icon:g}),e.jsx(gt,{icon:g})]})]})},Bt=()=>{const i=v(),{isModalOpen:n,openModal:l,closeModal:o}=E();return u.useEffect(()=>{i(de())},[i]),e.jsx(pe,{children:e.jsxs(me,{children:[e.jsx(bt,{isOpen:n}),e.jsxs(ge,{children:[e.jsx(Ue,{openSideBar:l}),e.jsx(u.Suspense,{fallback:e.jsx("div",{children:"Loading"}),children:e.jsx(he,{})})]}),e.jsx(Z,{onClick:o,className:n===!0&&"active"})]})})};export{Bt as default};
