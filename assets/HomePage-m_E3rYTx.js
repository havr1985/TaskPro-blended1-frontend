import{u as t,a as z,s as L,r as b,b as y,j as e,c as E,d as le,B,e as ce,f as V,g as de,N as Q,h as pe,i as H,k as ue,l as be,m as xe,n as he,C as me,O as ge}from"./index-EkPx1bNg.js";import{i as w}from"./icons-I0FOP6sp.js";import{S as D,a as X,M as Y,F as _,E as G,T as J,b as I,R as M,I as K,c as Z,D as N,B as ee,C as te,A as oe,d as ie,P as re,s as ae,u as P,O as ne,e as we,H as fe,f as ve}from"./HomePage.styled--QLBWk9Q.js";import{c as A,a as q,F as se,u as je}from"./index.esm-oA4FEjC-.js";/* empty css                      */const ye=t.header`
  height: 60px;
...
`,We=({children:o})=>e.jsx($e,{type:"submit",children:o}),Ue=t.img`
  height: 68px;
  width: 68px;
  border-radius: 8px;
`,He=t.label`
...
`,xt=["#icon-board-square","#icon-board-star","#icon-board-loading","#icon-board-puzzle","#icon-board-container","#icon-board-lightning","#icon-board-colors","#icon-board-hexagon"],ht=A().shape({title:q().required("Title is required!")}),mt=({isModalOpen:o,modalStateSwapper:i,gallery:r})=>{const a=y(),d=z(ae),{_id:p,title:l,icon:x,backgroundURL:h}=d.result,[m,v]=b.useState(h),[u,f]=b.useState(x),n=V(),g={title:l,icon:x,backgroundURL:h},j=c=>{c.preventDefault();const k=c.target.elements[0].value;if(!c.target.elements[0].value){B.error("Title is required!");return}const T={dashboardId:p,title:k,icon:u,backgroundURL:m};i(),a(pe(T)),a(H(p)),n(`/home/${k}`)},s=c=>{v(c)},C=c=>{f(c)};return e.jsx(D,{modalIsOpen:o,closeModal:i,title:"Edit board",maxWidth:"350px",children:e.jsx(X,{children:e.jsx(se,{initialValues:g,validationSchema:ht,children:e.jsxs(Y,{onSubmit:c=>j(c),children:[e.jsxs(_,{children:[e.jsx(G,{name:"title",component:"div"}),e.jsx(J,{type:"text",id:"title",defaultValue:l,name:"title",placeholder:"Title",autoComplete:"off"})]}),e.jsxs(_,{children:[e.jsx(I,{children:"Icons "}),e.jsx(M,{children:xt.map((c,k)=>e.jsxs(K,{children:[e.jsx(Z,{className:u===c?"active":"",onClick:()=>C(c),width:18,height:18,children:e.jsx("use",{href:w+c,width:18,height:18})}),e.jsx(N,{type:"radio",value:c,name:"icon"})]},k))})]}),e.jsxs(_,{children:[e.jsx(I,{children:"Backgraunds "}),e.jsx(M,{children:U.map((c,k)=>e.jsxs("label",{children:[e.jsx(ee,{onClick:()=>s(c[r]),className:m===c[r]?"active":"",children:c[r]!==""&&e.jsx(te,{$bcgurl:c[r],onClick:()=>s(c[r]),className:m===c[r]?"active":""})}),e.jsx(N,{type:"radio",value:c[r],name:"bg"})]},k))})]}),e.jsxs(oe,{type:"submit",children:[e.jsx(ie,{children:e.jsx(re,{children:e.jsx("use",{href:w+"#icon-plus"})})}),"Edit"]})]})})})})},gt=({icon:o,boards:i,selectedItem:r,choice:a,setUserBoards:d,isModalOpen:p,closeModal:l,setSelectedItemId:x,gallery:h,viewport:m})=>{const[v,u]=b.useState(!1),f=()=>{u(s=>!s)},n=s=>{let C="",c="";return i.forEach((k,S)=>{if(k._id===s){const T=i[S+1]?i[S+1]:i[S-1];T&&(C=`/home/${T.title}`,c=T._id)}}),{path:C,id:c}},g=y(),j=s=>{if(s){const C=g(H(n(s).id));x(C.arg)}g(ue(s))};return e.jsxs(e.Fragment,{children:[i.length!==0&&e.jsx(rt,{children:i.map(s=>e.jsxs(at,{onClick:()=>a(s),className:r._id===s._id?"active":"",children:[e.jsx(nt,{to:`/home/${s.title}`,children:e.jsxs(lt,{children:[e.jsx(W,{className:"iconBoard iconActive",width:"18px",height:"18px",children:e.jsx("use",{href:`${o}${s.icon}`})}),e.jsx(ct,{className:s.title.length>20&&"tooltip","data-tooltip":`${s.title}`,children:e.jsx(dt,{children:e.jsx(pt,{children:s.title})})})]})}),r._id===s._id&&e.jsxs(ut,{children:[e.jsx(bt,{onClick:()=>{m({width:window.innerWidth,height:window.innerHeight}),f()},type:"button",children:e.jsx(W,{className:"iconBoard iconEdit",width:"16px",height:"16px",children:e.jsx("use",{href:`${o}#icon-pencil`})})}),e.jsx(st,{to:n(s._id).path,onClick:()=>j(s._id),type:"button",children:e.jsx(W,{className:"iconBoard iconEdit",width:"16px",height:"16px",children:e.jsx("use",{href:`${o}#icon-trash`})})})]})]},s._id))}),e.jsx(it,{setUserBoards:d,isModalOpen:p,modalStateSwapper:l,gallery:h}),v&&e.jsx(mt,{isModalOpen:v,modalStateSwapper:f,gallery:h})]})},wt="/TaskPro-blended1-frontend/assets/plant-92SCXr2v.png",ft=t.div`
  width: 212px;
  height: 272px;
...
`,Lt=({openModal:o,icon:i,viewport:r})=>e.jsxs(e.Fragment,{children:[e.jsx(Mt,{children:"My boards"}),e.jsxs(Nt,{children:[e.jsx("p",{className:"createText",children:"Create a new board"}),e.jsx(qt,{onClick:()=>{r({width:window.innerWidth,height:window.innerHeight}),o()},type:"submit",children:e.jsx("svg",{className:"iconCreateBoard",width:"20px",height:"20px",children:e.jsx("use",{href:`${i}#icon-plus`})})})]})]}),Dt=[{width:372,height:812,deviceType:"url-mob"},{width:768,height:956,deviceType:"url-tab"},{width:1180,height:770,deviceType:"url-desk"}],Et=[{width:750,height:1624,deviceType:"url-mobx2"},{width:1536,height:1912,deviceType:"url-tabx2"},{width:2360,height:1540,deviceType:"url-deskx2"}],Ot=()=>{const[o,i]=b.useState(null);return{currentImage:o,selectImage:a=>{let p=window.devicePixelRatio===1?Dt:Et,l=1/0,x=o;for(const h of p){const m=Math.abs(a.width-h.width),v=Math.abs(a.height-h.height),u=m+v;u<l&&(l=u,x=h)}i(x.deviceType)}}},$t=({isOpen:o})=>{const[i,r]=b.useState(""),[a,d]=b.useState(""),p=z(we),{result:l}=z(ae),[x,h]=b.useState([]),m=y(),{isModalOpen:v,openModal:u,closeModal:f}=P();b.useEffect(()=>{h(p)},[p]),b.useEffect(()=>{r(l??"")},[l]);const n=s=>{i._id!==s._id&&a!==s._id&&(m(H(s._id)),d(s._id))},{selectImage:g,currentImage:j}=Ot();return e.jsxs(Je,{className:o===!0&&"active",children:[e.jsxs(e.Fragment,{children:[e.jsx(tt,{icon:w}),e.jsx(Lt,{openModal:u,viewport:g,icon:w}),e.jsx(Ke,{children:e.jsx(gt,{icon:w,boards:x,choice:n,selectedItem:i,isModalOpen:v,closeModal:f,setSelectedItemId:d,gallery:j,viewport:g})})]}),e.jsxs(Ze,{children:[e.jsx(Tt,{icon:w}),e.jsx(It,{icon:w})]})]})},Ft=()=>{const o=y(),{isModalOpen:i,openModal:r,closeModal:a}=P();return b.useEffect(()=>{o(he())},[o]),e.jsx(me,{children:e.jsxs(fe,{children:[e.jsx($t,{isOpen:i}),e.jsxs(ve,{children:[e.jsx(Ge,{openSideBar:r}),e.jsx(b.Suspense,{fallback:e.jsx("div",{children:"Loading"}),children:e.jsx(ge,{})})]}),e.jsx(ne,{onClick:a,className:i===!0&&"active"})]})})};export{Ft as default};
