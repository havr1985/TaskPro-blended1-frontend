import{u as h,t as oa,j as o,r as N,v as ia,w as ot,R as g,x as gt,b as ke,y as Ln,a as bt,z as In,A as Wn,D as Fn,E as $n,F as Rn,G as la,i as ca,H as zn,q as Vn,f as Yn,I as Bn}from"./index-hV3Eo9wO.js";import{i as U}from"./icons-I0FOP6sp.js";import{g as qn,w as Gn,h as s,i as yt,u as Le,S as xt,p as Hn,s as ir,a as sa,M as ua,F as da,E as fa,d as ha,P as pa,O as Ir,e as Un}from"./HomePage.styled-Hoen0zfX.js";import{b as lr,E as va,c as wt,a as ge,d as ma,F as Dt}from"./index.esm-vz7Jw-Ej.js";const Zn=h.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,xc=()=>{var v;const[e,t]=N.useState(!1),[a,r]=N.useState(""),n=N.useRef(!0),{boardName:l}=Vn(),i=Yn(),c=la(),u=bt(Un),d=ke(),[p,m]=N.useState(u),w=()=>{const y=c.pathname.split("/")[2];return u.filter(D=>D.title===y)};return N.useEffect(()=>{r(l)},[c.pathname,l]),N.useEffect(()=>{var y;if(m(u),!(n.current!==!0&&l!==a)){if(u.length===0&&i("/home",{replace:!0}),p.length!==u.length&&l&&u.length>0&&d(ca((y=u[u.length-1])==null?void 0:y._id)),u.length>0&&!l){t(!0);const D=u[u.length-1]??"";r(D.title),i(`/home/${D.title}`,{replace:!0,state:{id:D._id}}),t(!1)}n.current=!1}},[u,i,l,a,p.length,d]),o.jsx(fc,{$bcgurl:(v=w()[0])==null?void 0:v.backgroundURL,children:e?o.jsx("div",{children:o.jsx(Bn,{})}):l===void 0&&o.jsx(hc,{children:o.jsxs(pc,{children:["Before starting your project, it is essential"," ",o.jsx(vc,{children:"to create a board"})," to visualize and track all the necessary tasks and milestones. This board serves as a powerful tool to organize the workflow and ensure effective collaboration among team members."]})})||l!==void 0&&o.jsxs(o.Fragment,{children:[o.jsx(co,{boardName:l}),o.jsx(dc,{})]})})};export{xc as default};
