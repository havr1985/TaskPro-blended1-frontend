...
export const NeedHelp = ({ icon }) => {
	...
	return (
		<>
			<HelpWrapper>
				<img className='img-plant' src={plant} alt='Happy plant' />
				<HelpText>
					If you need help with <span className='appName'>TaskPro</span>, check out our support resources or reach out
